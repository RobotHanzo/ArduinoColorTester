...
int ScheduledTask::getTaskId() {
    return taskId;
}

void ScheduledTask::setTaskId(int taskId) {
    this->taskId = taskId;
}

int ScheduledTask::getStatusCode() {
    return statusCode;
}

void ScheduledTask::setStatusCode(int statusCode) {
    this->statusCode = statusCode;
}

JsonObject ScheduledTask::getDetails() {
    return details;
}

void ScheduledTask::setDetails(JsonObject details) {
    this->details = details;
}

long ScheduledTask::getEstimatedBeginIn() {
    return estimatedBeginIn;
}

void ScheduledTask::setEstimatedBeginIn(long estimatedBeginIn) {
    this->estimatedBeginIn = estimatedBeginIn;
}

long ScheduledTask::getElapsed() {
    return elapsed;
}

void ScheduledTask::setElapsed(long elapsed) {
    this->elapsed = elapsed;
}

long ScheduledTask::getEstimatedCompletionIn() {
    return estimatedCompletionIn;
}

void ScheduledTask::setEstimatedCompletionIn(long estimatedCompletionIn) {
